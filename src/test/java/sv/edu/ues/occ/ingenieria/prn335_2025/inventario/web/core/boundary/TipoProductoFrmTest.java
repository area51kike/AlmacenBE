...
class TipoProductoFrmTest {
    ...
    @Test
    void btnNuevoHandler() {
    }

    @Test
    void btnCancelarHandler() {
    }

    @Test
    void btnGuardarHandler() {
    }

    @Test
    void btnEliminarHandler() {
    }

    @Test
    void btnModificarHandler() {
    }
    ...
    @Test
    void getTiposProductoHierarchy() {
    }

    @Test
    void getTipoProductoPadreSeleccionado() {
    }

    @Test
    void setTipoProductoPadreSeleccionado() {
    }
}